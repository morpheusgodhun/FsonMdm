        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppLabel = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    VersionName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrollmentKey = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastScreenshotPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastScreenshotAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    AppLabel = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    IsLaunchable = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceApps_DeviceId_PackageName",
                table: "DeviceApps",
                columns: new[] { "DeviceId", "PackageName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DeviceLocations_DeviceId_CapturedAt",
